...
paswrd.geometry("400x300")

lab1=LabelFrame (paswrd, text="How many characters?", font=("lucida 15 bold"),fg='white',bg='#32405b')
lab1.pack(pady=20)
...
button1=Button (frm, text="Generate Password!", font=("lucida 15 bold"),bg="#00bfff", command=generate)
