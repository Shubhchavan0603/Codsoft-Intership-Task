...
class ToDoList:
    def __init__(self,root):
        ...
        self.task_label=tk.Label(self.heading_frame, text="Enter your task:", fg="black", bg="light blue", font="lucida 15 bold")
        self.task_label.pack(side=tk.TOP)

        self.task_entry=tk.Entry(self.heading_frame, font="lucida 20 bold")
        self.task_entry.pack(side=tk.BOTTOM)

        self.add_button=tk.Button(self.heading_frame, text="Add Task", command=self.add_task, font="lucida 18", bg="Blue", fg="white")
